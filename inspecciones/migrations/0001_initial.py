    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_de_respuesta', models.CharField(choices=[('cuadricula', 'Cuadricula'), ('parte_de_cuadricula', 'Parte De Cuadricula'), ('seleccion_unica', 'Seleccion Unica'), ('seleccion_multiple', 'Seleccion Multiple'), ('parte_de_seleccion_multiple', 'Parte De Seleccion Multiple'), ('numerica', 'Numerica')], max_length=50)),
